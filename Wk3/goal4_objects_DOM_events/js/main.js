...
var act1 = {
	...
	studentCount: 16000,
	students:[
		{name:'Kim Holcom', GPA:4.0, classes:['PWA1', 'MMD1', 'PWA2', 'MMD2']},
		{name:'James Bond', GPA:3.9, classes:['PWA1', 'PWA2']},
		{name:'Jane Doe', GPA:3.2, classes:['MMD1, MMD2']}
	]
};
	console.log(act1.schoolName);
	console.log(act1['schoolName']);
	var newCnt = 'studentCount';
	console.log(act1[newCnt]);
	console.log(act1['address']);
	console.log(act1.students[1].GPA);
	console.log(act1['students'][2]['GPA']);
...
function gradeAvg(students){
	var totalGPA = 0;
	for (var i = 0, j = act1.students.length; i < j; i++){
		totalGPA += act1.students[i].GPA;
	};
	var avgGPA = totalGPA / act1.students.length;
	return avgGPA;
};

	console.log(gradeAvg(act1.students));
/* ===============================================================
...
// #3 - shows and array of objects, inside of an object length
	...
	console.log(act1.students.length);
...
//	nav[i].onclick = function (e) {
//		for (ii = 0, max2 = nav.length; ii < max2; i++) {
