...
var str = "personal email is jc@google.com work email is jc@google.com";

console.log(emailRegExp.exec(str));
console.log(emailRegExp.test(str));

	console.log(str.search(emailRegExp));
	var clean = str.replace(emailRegExp, "xxx@xxx.com");
	console.log(clean);
	var clean = str.replace(emailRegExp, "jc@gmail.com");
	console.log(clean);
...
STUDENT ACTIVITY
	...
	1.  Format: (123) 456-7890 | 123-456-7890
		...
		Answer: /[(]{0,1}\d{3}[)]{0,1}[-]{0,1}\d{3}[-]{1}\d{4}/
...
----------------------------------------------------------------------------- */
var myPhoneStr = "My phone Number is 123-456-7890";
var	myPhoneExp = /((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}/;
	console.log(myPhoneStr.match(myPhoneExp));

var myPhoneStr2 = "My phone Number is 573 234 1256";
var myPhoneExp2 = /((\(\d{3}\)?)|(\d{3}-?)|(\d{3} ?))?((\d{3}?)|(\d{3}-?)|(\d{3} ))?\d{4}/;
	console.log(myPhoneStr2.match(myPhoneExp2));
/*
==================================================================
	Math Methods
	------------------------------------------------------------------
