...
console.log("The array holds the following sports: " + myArray[0] + ", " + myArray[1] + ", and " + myArray[2] + ".")
...
console.log("counter = " + myCounter(5));
...
console.log("Bob is " + mood("Sunny", 10) + ".");