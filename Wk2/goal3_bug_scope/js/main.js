...
// Array - For Loop
   // var students1 = ['Bob','Christine','Sally','Jim'];
	...
	//for(var i = 0; i < students1.length; i++){
		...
		//console.log(studentIndex, students1[i]);
	//};
...
/*
	//Example1
	var name = 'james', course = 'PWA1', month = 3;			//added ' ' around james, and ' at end of PWA1
	console.log ("name: ", name + " / course: ", course + " / month: ", month);		//added ; at end of line also changed coures to course


    //Example2:
	//string w/ escape charaters and mixed single/double quotes
	var phrase = 'he\'s in ' + " 'PWA1' ";			//had to use the escape character also switch the " and ' before PWA1
	console.log("phase 4: ", phrase);				//changed the @ to an 'a'


    //Example3:
	//nested conditional statement
	var a;				//added variable a because none had been declared
	var b;				//added variable b because none had been declared
	if (a === a){    //1st IF statement
		...
		console.log("nested conditional: 1st IF returned false"); 	//added the " at the end of the string
	};
	...
	var mood = function(weather, waves){			//added opening {

		if (weather == "Sunny"){			//changed = to ==
			if (waves === 10){
				Mood = 'PUMPED';
		...
		return Mood;	//changed Moood to Mood (misspelled)
	};
